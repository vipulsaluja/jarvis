...
- [x] T1: Extract entities from conversation and upsert semantic memory
...
- [x] T2: Detect preference statements and update preferences.json
...
- [x] T3: Detect commitments and decisions for prospective memory
...
- [x] T4: Wire extraction pipeline into post-conversation job
